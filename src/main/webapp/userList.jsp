            ...
            <div id="layoutSidenav_content">
                <main>
                                        ...
                                        <tbody>
                                            <c:forEach var="user" items="${listUser}">
                                                <tr>
                                                    ...
                                                    <td><a href="UserListServlet/edit?id=<c:out value='${user.id}' />">Edit</a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp; 
                                                        <a href="UserListServlet/block?id=<c:out value='${user.id}' />">Block</a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp; 
                                                        <a href="UserListServlet/delete?id=<c:out value='${user.id}' />">Delete</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                    ...
                    <div class="container text-right">
                        <a href="BlockedUserServlet" class="btn btn-success">Blocked User</a>
                    </div>
                </main>
