<%-- 
    ...
    Created on : May 7, 2020, 12:45:32 PM
    Author     : sonam
--%>

<%@page import="com.mycompany.usermanagement.model.User"%>
<%@page import="com.mycompany.usermanagement.model.History"%>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">History Log</h1>


                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>User History</div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <% ArrayList<History> history
                                                        = (ArrayList<History>) request.getAttribute("history");
                                                for (History h : history) { %> 
                                            <tr>
                                                <td><% out.println(h.getId()); %></td>
                                                <td><% out.println(h.getUname()); %></td>
                                                <td><% out.println(h.getDate()); %></td>
                                                <td><% out.println(h.getActivity()); %></td>
                                            </tr>
                                            <% }%>
                                        </tbody>
                                    </table>
