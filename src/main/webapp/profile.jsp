            ...
            <div class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <ul class="navbar-nav ml-auto ml-md-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class='fas fa-user-alt' style='font-size:25px'></i></a>
                            ...
                            <div class="cardd">
                                <div class="cover">
                                    ...
                                    <div class="covermiddle">
                                        <a class="btn btn-link" href="uploadCoverPic.jsp">Change Picture</a>
                                    </div>
                                </div>
                                ...
                                <div class="profile">
                                    ...
                                    <div class="middle">
                                        <a class="btn btn-link" href="uploadProfilePic.jsp">Change Picture</a>
                                    </div>
                                </div>
