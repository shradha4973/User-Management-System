<%-- 
    Document   : adminreportblocked
    Created on : Jun 6, 2020, 7:34:04 PM
    Author     : sonam
--%>

<%@page import="com.mycompany.usermanagement.model.User"%>
<%@page import="com.mycompany.usermanagement.model.AdminReport"%>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="UserListServlet.jsp">
                ...
                <main>
                    <div class="container-fluid">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="getBlocked">
                                Blocked User
                            </a>
                        </div>
                        <h1 class="mt-4">List of Blocked Users </h1>


                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>User Report</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <% ArrayList<AdminReport> report
                                                    = (ArrayList<AdminReport>) request.getAttribute("AdminReport");
                                            for (AdminReport ar : report) { %> 


                                        <tbody>
                                            <tr>
                                                <td><% out.println(ar.getId()); %></td>
                                                <td><% out.println(ar.getUname()); %></td>
                                                <td><% out.println(ar.getDate()); %></td>
